...
# title of the app
st.title("My Visualization App")

#headeer
st.header("A simple Data Visualizaton app to gather insights of your data")

# Add a sidebar
st.sidebar.subheader("Visualization Settings")

#
uploaded_file = st.sidebar.file_uploader(label="Upload Your Data",type=['csv', 'xlsx'])
